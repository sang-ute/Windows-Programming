...
namespace QLSV.my_DBDataSetTableAdapters {
...
SELECT id, fname, lname, bdate, gender, phone, address, picture FROM std WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QLSV.Properties.Settings.Default.my_DBConnectionString;
        }
        ...
        public virtual int Fill(my_DBDataSet.stdDataTable dataTable) {
        ...
        public virtual my_DBDataSet.stdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            my_DBDataSet.stdDataTable dataTable = new my_DBDataSet.stdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(my_DBDataSet.stdDataTable dataTable) {
